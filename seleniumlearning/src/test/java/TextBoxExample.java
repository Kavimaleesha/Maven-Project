...
public class TextBoxExample {
        ...
        public void textBoxTests(){
            ...
            driver.findElement(By.id("j_idt88:j_idt99")).sendKeys("kaviigunawardhana2000@gmail.com" + Keys.TAB + "Confirm control moved to next element.");
